...
# cells:
# input : data and historical hidden states
# output : updated (add new, remove oldest) hidden states

# The implementation of MLSTMCell and MLSTMFCell is based on the Zhao et al. (2020), for more details, please refer to : https://github.com/huawei-noah/noah-research/tree/master/mRNN-mLSTM
# We use the almost the same implementation of Zhao et al. (2020) for MGRUCell and MGRUFCell
...
# in our pre-experiment, we find that the following two cells require more time to train
# but we still provide the implementation of these two cells
