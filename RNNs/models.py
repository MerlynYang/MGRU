...
class RNNModel(nn.Module):
    def __init__(self, rnn_type, input_size, hidden_size, output_size, device, dropout):
...
class MRNNFModel(nn.Module):
    def __init__(self, rnn_type, input_size, hidden_size, output_size, lag_k, device, dropout, init_d_value:list=None):
